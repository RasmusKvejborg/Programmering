package opgave_1.guifx;

import opgave_1.application.controller.Controller;
import opgave_1.application.model.Company;
import opgave_1.application.model.Employee;
...
public class EmployeeWindow extends Stage {
	...
	private void initControls() {
		if (employee != null) {
			...
			txfEmployementYear.setText(""+employee.getEmployementYear());
...
//----------------
	...
	//--------------------------------------- employment year slut
				...
				if (employee != null) {
					...
					if (companyIsSelected) {
						Controller.createEmployee(name, wage, newCompany, employementYear); //employement year tilføjet
					} else {
