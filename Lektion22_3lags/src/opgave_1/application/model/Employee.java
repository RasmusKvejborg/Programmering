package opgave_1.application.model;
...
public class Employee {
	...
	public Employee(String name, int wage, int employementYear) {
		this.name = name;
		this.wage = wage;
		this.employementYear = employementYear;
	}


	//getter+setter of employementyear
	public int getEmployementYear() {
		return employementYear;
	}
	public void setEmployementYear(int employementYear) {
		this.employementYear = employementYear;
	}
