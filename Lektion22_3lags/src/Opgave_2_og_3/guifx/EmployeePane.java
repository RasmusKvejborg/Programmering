...
public class EmployeePane extends GridPane {
	...
	private void createAction() {
		...
		lvwEmployees.getItems().setAll(Controller.getEmployees()); // her skal jeg også have noget hvis man skal kunne oprette kunden
		this.updateControls();
	}
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			txfEmploymentYear.setText(""+ employee.getEmployementYear()); // employmentyear skal også updates
